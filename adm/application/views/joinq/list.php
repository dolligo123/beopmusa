<main class="main-wrap">
	<div class="card-wrap">
		...
		<div class="top-btn-wrap">
			<ul class="clearfx">
				<li>
					<input type="text" id="bp_name" value="<?php echo $this->input->get('bp_name'); ?>" placeholder="법무사명 검색" />
				</li>
				<li>
					<input type="text" id="local" value="<?php echo $this->input->get('local'); ?>" placeholder="지역 검색" />
				</li>
				<li>
...
<script>
	$(document).ready(function() {
		var bp_name = getParameter('bp_name');
		...
		function change_url() {
			...
			if (local != "") param += "&local=" + $('#local').val();
			if (tel != "") param += "&tel=" + $('#tel').val();
			if (bp_name != "") param += "&bp_name=" + $('#bp_name').val();
		...
		$(document).on("keyup", "#bp_name, #local, #tel", function() {
			change_url();
			dataTable.draw();
		});
