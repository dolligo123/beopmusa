<form name="form" action="/adm/notice/post" enctype="multipart/form-data" method="post" onsubmit="return chkval();" >
    ...
    <main class="main-wrap">
        <div class="card-wrap">
            ...
            <dl>
                ...
                <dd>
                    <input type="text" name="title" placeholder="제목 입력하세요." value="<?=$notice['title']?>" required />
                </dd>
            </dl>
            <dl>
                <dt>
                ...
                <dd>
                    <textarea name="content" id="content" rows="10" cols="100" style="width:100%; height:400px; display:none;"><?=$notice['content']?></textarea>
                </dd>
            </dl>             
        </div>
